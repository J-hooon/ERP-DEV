...
This repository was detected as **public** at bootstrap time. Do not commit real company orders, business-registration data, settlement data, credentials, private fixtures, or proprietary operational data until the repository is changed to private. Secrets must never be committed regardless of repository visibility.
